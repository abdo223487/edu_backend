...
public record QuizListItem(int Id, string Title, int UnitId, DateTime StartAt, DateTime Deadline, List<int> GroupIds);

public record QuizDetailForStudent(int Id, string Title, int UnitId, DateTime StartAt, DateTime Deadline, List<QuestionDto> Questions);

public record QuizDetailForTeacher(int Id, string Title, int UnitId, DateTime StartAt, DateTime Deadline, List<QuestionTeacherDto> Questions);
