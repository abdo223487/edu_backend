...
namespace EduApi.Migrations
{
    ...
    [Migration("20260918002006_AddWatchedSecondsToLectureViewSession")]
    partial class AddWatchedSecondsToLectureViewSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduApi.Models.AssignmentCenterStudentOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AssignmentCenterStudentOverrides");
                });
            ...
            modelBuilder.Entity("EduApi.Models.ClassScheduleDay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TeacherId", "SchoolYear", "DayOfWeek")
                        .IsUnique();

                    b.ToTable("ClassScheduleDays");
                });

            modelBuilder.Entity("EduApi.Models.ClassScheduleEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TeacherId", "SchoolYear", "Date")
                        .IsUnique();
            ...
            modelBuilder.Entity("EduApi.Models.Code", b =>
                {
                    ...
                    b.Property<string>("ExternalBookIdsCsv")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EduApi.Models.ExternalBook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EduApi.Models.ExternalBookLesson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EduApi.Models.Lecture", b =>
                {
                    ...
                    b.Property<bool>("RequireLinkAssignment")
                        .HasColumnType("boolean");

                    b.Property<bool>("RequireLinkExam")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("EduApi.Models.LectureAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LectureAssignments");
                });

            modelBuilder.Entity("EduApi.Models.LectureAssignmentAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LectureAssignmentResultId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LectureAssignmentResultId");

                    b.ToTable("LectureAssignmentAnswers");
                });

            modelBuilder.Entity("EduApi.Models.LectureAssignmentQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LectureAssignmentId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LectureAssignmentQuestions");
                });

            modelBuilder.Entity("EduApi.Models.LectureAssignmentResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LectureAssignmentId", "StudentId")
                        .IsUnique();

                    b.ToTable("LectureAssignmentResults");
                });

            modelBuilder.Entity("EduApi.Models.LectureAssignmentStudentOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LectureAssignmentStudentOverrides");
                });
            ...
            modelBuilder.Entity("EduApi.Models.LectureExamStudentOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LectureExamStudentOverrides");
                });
            ...
            modelBuilder.Entity("EduApi.Models.LectureViewSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EduApi.Models.MaterialGroupLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MaterialId", "GroupId")
                        .IsUnique();

                    b.ToTable("MaterialGroupLinks");
                });
            ...
            modelBuilder.Entity("EduApi.Models.StudentExternalBookSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StudentId", "ExternalBookId")
                        .IsUnique();

                    b.ToTable("StudentExternalBookSubscriptions");
                });
            ...
            modelBuilder.Entity("EduApi.Models.StudentLectureViewUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("StudentLectureViewUsages");
                });
            ...
            modelBuilder.Entity("EduApi.Models.StudentRegistrationRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Id", "AccessCode");

                    b.ToTable("StudentRegistrationRequests");
                });
            ...
            modelBuilder.Entity("EduApi.Models.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EduApi.Models.ExternalBookLesson", b =>
                {
                    b.HasOne("EduApi.Models.ExternalBook", "ExternalBook")
                        .WithMany("Lessons")
                        .HasForeignKey("ExternalBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ExternalBook");
                });

            modelBuilder.Entity("EduApi.Models.LectureAssignmentAnswer", b =>
                {
                    b.HasOne("EduApi.Models.LectureAssignmentResult", "LectureAssignmentResult")
                        .WithMany("Answers")
                        .HasForeignKey("LectureAssignmentResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LectureAssignmentResult");
                });

            modelBuilder.Entity("EduApi.Models.LectureAssignmentQuestion", b =>
                {
                    b.HasOne("EduApi.Models.LectureAssignment", "LectureAssignment")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("EduApi.Models.MaterialGroupLink", b =>
                {
                    b.HasOne("EduApi.Models.Material", null)
                        .WithMany()
